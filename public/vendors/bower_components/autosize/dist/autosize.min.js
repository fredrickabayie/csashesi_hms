...
!function (e, t) {
    ...
    function o(e) {
        ...
        function n() {
            var t = e.style.height, n = document.documentElement.scrollTop, i = document.body.scrollTop, r = e.style.height;
            e.style.height = "auto";
        ...
        var i = void 0 === arguments[1] ? {} : arguments[1], r = i.setOverflowX, d = void 0 === r ? !0 : r, s = i.setOverflowY, a = void 0 === s ? !0 : s;
        if (e && e.nodeName && "TEXTAREA" === e.nodeName && !e.hasAttribute("data-autosize-on")) {
            var l = null, u = "hidden", v = function (t) {
